...
import com.gaechuck_package.gaechuck.data.request.LoseCreateRequest
...
class LoseRepository {
    ...
    // 분실물 리스트 가져오기
    suspend fun getLoseData(page : Int, size: Int = 9, title:String): GetLoseDataResponse? {
        return try {
            val response = apiService.getLoseData(page,size, title)
