...
import com.gaechuck_package.gaechuck.data.request.BusinessDeleteRequest
import com.gaechuck_package.gaechuck.data.request.BusinessPatchRequest
import com.gaechuck_package.gaechuck.data.request.LoginRequest
import com.gaechuck_package.gaechuck.data.request.LoseDeleteRequest
import com.gaechuck_package.gaechuck.data.request.LosePatchRequest
import com.gaechuck_package.gaechuck.data.request.RefreshRequest
import com.gaechuck_package.gaechuck.data.request.RentDeleteRequest
import com.gaechuck_package.gaechuck.data.request.RentPatchRequest
import com.gaechuck_package.gaechuck.data.request.UrlChangeRequest
import com.gaechuck_package.gaechuck.data.response.BaseListResponse
...
import com.gaechuck_package.gaechuck.data.response.GetBusinessDataResponse
import com.gaechuck_package.gaechuck.data.response.GetBusinessDetailResponse
...
import com.gaechuck_package.gaechuck.data.response.GetFoodDataResponse
import com.gaechuck_package.gaechuck.data.response.GetLoseDataResponse
import com.gaechuck_package.gaechuck.data.response.GetLoseDetailResponse
import com.gaechuck_package.gaechuck.data.response.GetRentDataResponse
...
import com.gaechuck_package.gaechuck.data.response.PatchBusinessResponse
...
//        @Header("Authorization") token: String,
    ...
    suspend fun getAllNoticeData(
        ...
        @Query("title") title: String?
    ): Response<BaseResponse<PagenatedResponse<GetAllNoticeDataResponse>>>
    ...
    ): Response<BaseListResponse<GetFoodDataResponse>>
