package com.gaechuck_package.gaechuck.ui.business.adapter
...
import com.gaechuck_package.gaechuck.data.response.BusinessList
import com.gaechuck_package.gaechuck.databinding.RowBusinessItemBinding
            ...
            binding.buttonEtc.setOnClickListener {
                ...
                popupMenu.setOnMenuItemClickListener { menuItem ->
                    when (menuItem.itemId) {
                        com.gaechuck_package.gaechuck.R.id.menu_edit -> {
                            listener.onEditClicked(item)
                            true
                        }
                        com.gaechuck_package.gaechuck.R.id.menu_delete -> {
