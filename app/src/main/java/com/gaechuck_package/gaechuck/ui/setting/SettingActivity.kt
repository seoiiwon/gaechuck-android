...
import com.gaechuck_package.gaechuck.data.models.SettingItem
import com.gaechuck_package.gaechuck.ui.setting.adapter.SettingAdapter
...
class SettingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val items = listOfNotNull(
            ...
            AuthManager.getToken()?.takeIf { it.isNotEmpty() }?.let {
                SettingItem(getString(R.string.setting_title_3), "", false, false)
            }
        )
