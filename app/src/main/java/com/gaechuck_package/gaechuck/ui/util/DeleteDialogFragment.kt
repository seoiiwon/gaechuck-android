...
import com.gaechuck_package.gaechuck.databinding.DeletePopupBinding

class DeleteDialogFragment(
    private val context : Context,
    private val onConfirm: () -> Unit
) {
    private lateinit var binding: DeletePopupBinding // 뷰바인딩
    ...
    fun show() {
        ...
        if (dlg == null) {
            dlg = Dialog(context)
            binding = DeletePopupBinding.inflate(LayoutInflater.from(context))
            ...
            // 텍스트 적용
            binding.dialogTitleTv.text = "게시물을 삭제할까요?"
