...
import com.gaechuck_package.gaechuck.databinding.AlertPopupBinding

class WriteDialogFragment(private val context : Context) {
    ...
    fun show() {
        ...
        if (dlg == null) {
            ...
            // 텍스트 적용
            binding.dialogTitleTv.text = "모든 정보를 입력해주세요."
